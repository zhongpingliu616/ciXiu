<template>
	...
	<LayoutNavigation :title="title" > 
		...
		<view class="page-content">
			...
			<!-- Image Display -->
			<view class="image-card works-image">
			...
			<view class="xiuniang-information">
				<view class="sold-info">
					<u-card :border-radius="16" :padding="20" margin="20rpx 0" :show-head="false">
						<!-- ✅ body  -->
						<template #body>
							<!-- 价格区域 -->
...
const handlePayDeposit = ()=> {
  ...
  console.log('支付押金');
  uni.navigateTo({
    url: `/pages-gz/level/pay-deposit?amount=${detailData.value.money || 5000}`
  })
};
